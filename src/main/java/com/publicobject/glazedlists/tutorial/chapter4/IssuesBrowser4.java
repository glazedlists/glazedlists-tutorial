...
public class IssuesBrowser4 {
   ...
   */
  public IssuesBrowser4(Collection<Issue> issues) {
  ...
  public static void main(String[] args) {
    ...
    try (InputStream inputStream = IssuesBrowser4.class.getResourceAsStream("/issues.xml")) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        // create the browser
        IssuesBrowser4 browser = new IssuesBrowser4(issues);
        browser.display();
      }
    });
  }
