...
public void display() {
    ...
    MatcherEditor<Issue> textMatcherEditor = new TextComponentMatcherEditor<Issue>(
filterEdit, new IssueTextFilterator());
    FilterList<Issue> textFilteredIssues = new FilterList<Issue>(userFilteredIssues, textMatcherEditor);
    ThresholdList<Issue> priorityFilteredIssues = new ThresholdList<Issue>(
textFilteredIssues, new IssuePriorityThresholdEvaluator());
    SortedList<Issue> sortedIssues = new SortedList<Issue>(
priorityFilteredIssues, new IssueComparator());
    ...
}
----
